...
import { discordCallback } from "routes/login/discordCallback";
import { googleCallback } from "routes/login/googleCallback";
import { twitchCallback } from "routes/login/twitchCallback";
import { githubCallback } from "routes/login/githubCallback";
...
export const oauth2 = fp(async function OAuth2(app) {
